...
const PlatformPreview: React.FC = () => {
  ...
  return (
    <section className="bg-black relative overflow-hidden">
      <div
        ref={pinSectionRef}
        className="relative h-[84vh] md:h-[90vh] w-full overflow-hidden grid place-items-center"
      >
      ...
      <div className="max-w-[980px] w-full mx-auto px-6 pb-20 md:pb-28 -mt-16 md:-mt-24">
